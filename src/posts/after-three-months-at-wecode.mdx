...
현재 우리는 프론트엔드 4명으로 구성되어 있는데 놀랍게도 기획부터 디자인, 프론트엔드, 백엔드, 서버 배포까지 모두 진행하였고 추후 앱 개발 역시 예정되어 있다.<br />
비록 다른 언어를 배워본 적은 없지만 자바스크립트라는 언어는 정말 알면 알수록 매력적인
언어인 것 같다. 내 아이디어를 세상 밖으로 꺼내주는 마법같은 언어.. 공부하자!
